...
const messageSchema = {
  ...
  properties: {
    ...
    contact_id: { type: ['string', 'null'], description: 'Null for messages sent to a WhatsApp group.' },
    group_id: { type: ['string', 'null'], description: 'Set when this message was sent to (or received from) a synced WhatsApp group.' },
    broadcast_id: { type: ['string', 'null'], description: 'Set when this message was generated by a broadcast campaign.' },
